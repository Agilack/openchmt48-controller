...
#define TIM12_CR1    (TIM12 + 0x00)
#define TIM12_DIER   (TIM12 + 0x0C)
#define TIM12_EGR    (TIM12 + 0x14)
#define TIM12_CCMR1  (TIM12 + 0x18)
#define TIM12_CCMR2  (TIM12 + 0x1C)
#define TIM12_CCER   (TIM12 + 0x20)
#define TIM12_PSC    (TIM12 + 0x28)
#define TIM12_ARR    (TIM12 + 0x2C)
#define TIM12_CCR1   (TIM12 + 0x34)
#define TIM12_CCR2   (TIM12 + 0x38)
#define TIM12_CCR3   (TIM12 + 0x3C)
#define TIM12_CCR4   (TIM12 + 0x40)
#define TIM12_BDTR   (TIM12 + 0x44)
...
#define GPIOD_AFRL  (GPIOD + 0x020)
#define GPIOD_AFRH  (GPIOD + 0x024)
...
#define ADC_SMPR1   (ADC1 + 0x0C)
#define ADC_SMPR2   (ADC1 + 0x10)
